...
@Tag(name = "管理后台 - 文章评论")
@RestController
@RequestMapping("/app/oil-comment")
@Validated
public class AppArticleCommentController {
    ...
    @TenantIgnore
    @PermitAll
    public CommonResult<PageResult<ArticleCommentRespVO>> getArticleCommentPage(@RequestBody ArticleCommentPageReqVO pageReqVO) {
        pageReqVO.setPageSize(100);
        PageResult<ArticleCommentDO> pageResult = articleCommentService.getAppArticleCommentPage(pageReqVO);
